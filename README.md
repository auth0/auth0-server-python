...
The key must be a PKCS8 PEM private key whose public key is registered on your Auth0 application. The signing algorithm defaults to `RS256` and can be overridden with `client_assertion_signing_alg`.
